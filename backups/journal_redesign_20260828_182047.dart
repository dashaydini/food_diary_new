...
class _JournalScreenState extends State<JournalScreen> {
  ...
  Widget _buildTimeline(List<Map<String, dynamic>> visits) {
    if (visits.isEmpty) {
      return _empty('היומן שלך עדיין ריק', 'כל חוויה שתוסיף יופיע כאן.');
    }
  ...
  Widget _buildMemories() {
    if (_favorites.isEmpty) {
      return _empty(
        ...
        'כל חוויה כבר נמצא ביומן.\nסמן ❤️ ליד חוויה כדי לשמור אותו גם בזיכרונות.',
      );
    }
  ...
  Widget _buildStatistics() {
    ...
    return ListView(
      ...
      children: [
        _bigStat('מספר חוויות', '${_visits.length}', Icons.menu_book_outlined),
        ...
        _bigStat('חוויות עם משקה', '$drinks', Icons.local_cafe_outlined),
