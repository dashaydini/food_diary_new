...
class AddCoffeeVisitScreen extends StatefulWidget {
  final CoffeeCart cart;

  final CoffeeVisit? existingVisit;
  final bool viewOnly;

  const AddCoffeeVisitScreen({
    super.key,
    required this.cart,
    this.existingVisit,
    this.viewOnly = false,
  ...
  @override
  State<AddCoffeeVisitScreen> createState() => _AddCoffeeVisitScreenState();
}

class _AddCoffeeVisitScreenState extends State<AddCoffeeVisitScreen> {
  ...
  Widget imageBox() {
    return GestureDetector(
      onTap: widget.viewOnly ? null : chooseImage,
      child: Container(
        height: 220,
        ...
        body: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: widget.viewOnly ? null : pickDate,
            ),
            const SizedBox(
              height: 10,
            ),
