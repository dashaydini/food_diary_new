...
class CoffeeCartRepository {
  static const String boxName = 'coffee_carts';

  static final FirebaseCoffeeCartRepository _firebaseRepository =
  ...
  static Future<CoffeeCart?> add(
    ...
    final result = await _firebaseRepository.addCoffeeCart(cart);
  ...
  static Future<void> update(
    ...
    await _firebaseRepository.updateCoffeeCart(cart);
  }

  static Future<void> delete(
    CoffeeCart cart,
  ) async {
    await _firebaseRepository.deleteCoffeeCart(cart);
