...
import 'services/migrate_coffee_carts.dart';
...
Future<void> main() async {
  ...
  if (!Hive.isAdapterRegistered(CoffeeCartAdapter().typeId)) {
    Hive.registerAdapter(
      CoffeeCartAdapter(),
    );
  }

  if (!Hive.isAdapterRegistered(CoffeeVisitAdapter().typeId)) {
    Hive.registerAdapter(
      CoffeeVisitAdapter(),
    );
  }
  ...
  await FirebaseSyncService().syncCoffeeCarts();

  await MigrateCoffeeCarts().run();
