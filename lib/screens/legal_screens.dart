    ...
    return _LegalDocumentScreen(
      ...
      sections: const [
        ...
        _LegalSection(
          ...
          body:
              'העדפות ההתראות מופעלות כברירת מחדל ועשויות לכלול קופונים ומבצעים, תיוגים, עוקבים חדשים, הודעות מערכת ועדכונים למנהלי מקומות. שליחת התראה לטלפון מחייבת גם אישור נפרד של מערכת ההפעלה. ניתן לכבות את כלל ההתראות או כל סוג בנפרד במסך ההגדרות.',
        ),
        _LegalSection(
