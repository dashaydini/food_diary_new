...
class CoffeeCoffeeCartDetailsScreen extends StatefulWidget {
  final CoffeeCart cart;
  final bool myContentOnly;

  const CoffeeCoffeeCartDetailsScreen({
    super.key,
    required this.cart,
  ...
  @override
  State<CoffeeCoffeeCartDetailsScreen> createState() =>
      _CoffeeCoffeeCartDetailsScreenState();
}

class _CoffeeCoffeeCartDetailsScreenState
    extends State<CoffeeCoffeeCartDetailsScreen> {
